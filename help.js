...
const helpEmbed = new Discord.RichEmbed()
	...
	.addBlankField()
	.addField("✉️ Invite", `\`${config.prefix}invite \`\nBot invite link to share, website link, Support Server link, summary of bot.`)
	.addBlankField()
	.addField("🛠️	Set Status Channel where all statuses will be posted", `\`${config.prefix}setstatuschannel " #channel "\`\nTip: Use a space after <"> as shown above so you can link the channel`)
	.addBlankField()
